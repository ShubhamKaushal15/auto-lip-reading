...
class ConvTransformer(torch.nn.Module):
    def __init__(self, transformer_dim: int=512, output_dim: int=29, dropout_p=0.5):
        ...
        self.transformer = LipTransformer(transformer_dim)
    ...
    def forward(self, x, y):
        ...
        # y should be preprocessed to have start and stop tokens
